      ...
      <div className="relative flex">
        <div className="w-full mt-6 space-y-4">
          ...
          <p className="text-xl text-secondColor font-bold">
            Here are a few{" "}
            <span className="font-black text-2xl text-greenTextColor underline">
              Technologies
            </span>{" "}
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            {icons.map((icon: any, key: any) => (
              <div
                className="bg-gray-800 flex items-center gap-2 rounded-lg px-4 py-2"
                key={icon.url}
              >
                <img src={icon.url} alt={icon.desc} className="w-6 h-6" />
